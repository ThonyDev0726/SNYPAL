...
function redireccion() {
    window.location = "http://192.168.1.4:8080/FACTURING/Controller?accion=iniciar-sesion";
}

// se llamará a la función que redirecciona después de 5 minutos (300000 segundos)
//var temp = setTimeout(redireccion, 300000);
...
//    temp = setTimeout(redireccion, 300000);
//})


//funcion para que no se pueda volver hacia atras
